...
MaxSpawnDistance             = 90;               // Max distance a zombie should spawn from a player.
MaxDistance			         = 150;              // Max distance to players before delete.
MaxTime                      = 15;               // Max time away from a player before delete.
...
ZombieRespect                = 15;               // Respect per zombie kill
...
Trigger_1 = [				 //NWA TEMPLE RUINS
/* 0  Use this trigger */    True,               // Self - explanatory
/* 1  Trigger Positions */   NoBuildings,        // The name of the array used to list all trigger position in the TriggerPositions.sqf file
/* 2  Max Zombies */         50,                 // The maximum number of zombies for that trigger.
...
/* 5  Respawn Delay */       15,                 // The respawn delay after the max group size was reached
...
/* 9  Marker Alpha */        0.5,                // Alpha of the trigger *(0 is invisible 1 is opaque)
...
Trigger_2 = [				 //NWA CUSTOM MOUNT TANOA
...
Trigger_3 = [				 //NWA CUSTOM RAD ZONE BOTTOM
/* 0  Use this trigger */    True,               
...
Trigger_4 = [				 //NWA CUSTOM RAD ZONE TOP
/* 0  Use this trigger */    True,               
...
// TRIGGER_1 NWATempleRuins		// WEAPONS MED / MED RARE
// TRIGGER_2 NWAMountTanoa		// CONSTRUCTION MED / MED RARE
// TRIGGER_3 NWARadBottom		// CONSTRUCTION HIGH / HIGH RARE
// TRIGGER_4 NWARadTop			// WEAPONS HIGH / HIGH RARE
