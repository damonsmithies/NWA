...
SC_maxAIcount					= 25;						// the maximum amount of AI, if the AI count is above this then additional AI won't spawn
...
SC_occupyLootCratesLocations	= [
                                    [11014.884,8449.108,0], // NWA TEMPLE RUINS
									[9950.311,12106.368,0.001], // NWA CUSTOM MOUNT TANOA
									[2257.881,12564.815,0], // NWA CUSTOM RAD ZONE BOTTOM
									[3374.446,12859.568,0] // NWA CUSTOM RAD ZONE TOP
									
                                ];
SC_numberofLootCrates       	= 4;                    	// if SC_occupyLootCrates = true spawn this many loot crates (overrided below for Namalsk)
SC_LootCrateGuards          	= 0;                    	// number of AI to spawn at each crate
...
SC_LootCrateItems           	= [
									...
									["O_IR_Grenade",0,1],
									["I_IR_Grenade",0,1],
									["1Rnd_HE_Grenade_shell",0,1],
									["3Rnd_HE_Grenade_shell",0,1],
									["APERSBoundingMine_Range_Mag",0,1],
									["APERSMine_Range_Mag",0,1],
									["APERSTripMine_Wire_Mag",0,1],
									["ClaymoreDirectionalMine_Remote_Mag",0,1],
									["DemoCharge_Remote_Mag",0,1],
									["IEDLandBig_Remote_Mag",0,1],
									["IEDLandSmall_Remote_Mag",0,1],
									["IEDUrbanBig_Remote_Mag",0,1],
									["IEDUrbanSmall_Remote_Mag",0,1],
									["SatchelCharge_Remote_Mag",0,1],
									["SLAMDirectionalMine_Wire_Mag",0,1],
									
									// GEAR
									["Exile_Headgear_GasMask",0,1],
									...
									["B_Bergen_blk",0,1],
									["I_UavTerminal",0,1],
									["I_UAV_01_backpack_F",0,1],
									
									// CONSTRUCTION
									["Exile_Item_Laptop",0,1],
                                    ["Exile_Item_CodeLock",0,1],
									["Exile_Item_SafeKit",0,1],
									...
									// MEDICAL
                                    ["Exile_Item_InstaDoc",2,3],
									["Exile_Item_Defibrillator",1,2],
									["Exile_Item_Vishpirin",2,3],

									// FOOD AND DRINK
									["Exile_Item_PlasticBottleFreshWater",3,4],
									["Exile_Item_InstantCoffee",3,4],
									["Exile_Item_EMRE",3,4],
									["Exile_Item_Bandage",3,4],

									// CONSTRUCTION
									["Exile_Item_JunkMetal",0,1],
									["Exile_Item_LightBulb",0,1],
									["Exile_Item_MetalBoard",0,1],
									["Exile_Item_MetalPole",0,1],
									["Exile_Item_MetalWire",0,1],
									["Exile_Item_CementExile_Item_Sand",0,1],
									...
									// OTHER
									["Exile_Item_Magazine01",0,1],
									["Exile_Item_Magazine02",0,1],
									["Exile_Item_Magazine03",0,1]
                            ];
...
SC_numberofHeliCrashes      	= 30;                    // if SC_occupyHeliCrashes = true spawn this many loot crates
