...
Kopiert den "bikey" aus "Extended_Base_Mod\keys\ExtendedBase3.1.bikey" in euren "Keys" Ordner auf dem Server. löscht den alten key davor raus!
///////////////////////////////////////////////////////////////////////////////////////////////////////
...
2. löscht ExtendedBase3.0.bikey im Keys Ordner
4. Kopiert den neuen "@Extended_Base_Mod" ordner von dem neu runtergeladenen
5. Kopiere ExtendedBase3.1.bikey in deinen Keys ordner
...
V 0.3.1
-  80 neue Objekte eingefügt // Danke an Kurewe für das Bereitstellen von 64 codes!!! :) Feiert ihn jungs! :D  
	: TV, Stühle, Konsolen set, Fitnessbank und Hanteln, Büromöbel, PC set, Trophäen, Sonnenschirme, 
	Sachen für die Garage, wie einen Motorkran, Werkzeugschränke, Helipadlichter, Bildschirme, Ziele,...
- Battleye filter überarbeitet!
- Rezeptkategorien überarbeitet!
- Simulation am Serverrestart gefixt
