...
/* Mission System Settings */
	...
	DMS_MissionMarkerWinDotTime			= 120;						// How many seconds the "win" mission dot will remain on the map
	DMS_MissionMarkerLoseDotTime		= 120;						// How many seconds the "lose" mission dot will remain on the map
	...
	DMS_PlayerNearBlacklist				= 300;						// Missions won't spawn in a position this many meters close to a player
	DMS_SpawnZoneNearBlacklist			= 300;						// Missions won't spawn in a position this many meters close to a spawn zone
	...
	DMS_dynamicText_Duration			= 10;						// Number of seconds that the message will last on the screen.
...
/* AI Settings */
	...
	DMS_AIMoney_PopulationMultiplier	= 25;						// This determines how much EXTRA money an AI will have on his body. For example, setting this to 5 and having a server population of 30 means the AI will have an extra 150 poptabs on the body. Set to 0 to disable.
	...
	DMS_Bandit_Soldier_MoneyGain		= 250;						// The amount of Poptabs gained for killing a bandit soldier
	DMS_Bandit_Soldier_RepGain			= 250;						// The amount of Respect gained for killing a bandit soldier
	DMS_Bandit_Soldier_RankGain			= 15;
	DMS_Bandit_Soldier_SpawnMoney		= 250;						// The amount of Poptabs carried by a bandit soldier

	DMS_Bandit_Static_MoneyGain			= 250;						// The amount of Poptabs gained for killing a bandit static gunner
