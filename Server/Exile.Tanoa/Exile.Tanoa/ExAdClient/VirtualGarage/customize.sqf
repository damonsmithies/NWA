...
ExAd_VG_ACCESS_LEVEL = 2; 				//SCALAR - Lowest level that can access the Virtual Garage --> 1|2|3 -> Pleb|Moderator|Owner.
...
ExAd_VG_ALLOWED_VEH_TYPE = ["Car","Air","Tank","Helicopter"];//ARRAY - Array with allowed vehicle types for the virtual garage. | "Car", "Tank", "Helicopter", "Plane" or "Air" for both WARNING DON'T USE "LandVehicle" Can crash the Exile system.  