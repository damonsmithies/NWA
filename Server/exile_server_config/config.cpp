...
class CfgSettings
{
    ...
    {    
        ...
        */
        groundVehicleAmount = 0; //"0"=Disabled
        waterVehicleAmount = 0; //"0"=Disabled
        airVehicleAmount = 0; //"0"=Disabled
        /**
        ...
        */
        groundDamageChance = 5; // 20% chance for a vehicle HITPOINT to be damaged
        waterDamageChance = 5; // 20% chance for a vehicle HITPOINT to be damaged
        airDamageChance = 5; // 20% chance for a vehicle HITPOINT to be damaged
        
        groundMaximumDamage = 0; // vehicle HITPOINT to be damaged
        waterMaximumDamage = 0; // vehicle HITPOINT to be damaged
        airMaximumDamage = 0; // vehicle HITPOINT to be damaged
        /**
        ...
        ground[] = 
        {
            ...
            "Exile_Car_Hunter", //INC
            "Exile_Car_Ifrit",  //INC
            //"Exile_Car_Ikarus_Party",
            //"Exile_Car_Kart_RedStone",
            //"Exile_Car_Lada_Hipster",
            "Exile_Car_LandRover_Urban", //INC
            "Exile_Car_LandRover_Ambulance_Green", //INC
            "Exile_Car_MB4WD",
            "Exile_Car_MB4WDOpen",
            //"Exile_Car_Octavius_Black",
            "Exile_Car_Offroad_Guerilla06", //INC
            //"Exile_Car_Offroad_Armed_Guerilla12",
            "Exile_Car_Offroad_Repair_Civillian", //INC
            //"Exile_Car_OldTractor_Red",
            "Exile_Car_ProwlerUnarmed",
            "Exile_Car_QilinUnarmed",
            "Exile_Car_Strider", //INC
            "Exile_Car_SUV_Black", //INC
            "Exile_Car_SUVXL_Black", //INC
            "Exile_Car_SUV_Armed_Black", //INC
            "Exile_Car_Tempest", //INC
            //"Exile_Car_TowTractor_White",
            //"Exile_Car_Tractor_Red",
            "Exile_Car_UAZ_Green", //INC
            "Exile_Car_UAZ_Open_Green", //INC
            "Exile_Car_Ural_Covered_Military", //INC
            "Exile_Car_Ural_Open_Military", //INC
            "Exile_Car_V3S_Covered",
            "Exile_Car_V3S_Open",
            "Exile_Car_Van_Guerilla02", //INC
            "Exile_Car_Van_Box_Guerilla04", //INC
            "Exile_Car_Van_Fuel_Guerilla03", //INC
		...
		* The server will apply random damage up to this value when spawning a vehicle.
		*/
		damageChance = 5; // 20% chance for a vehicle HITPOINT to be damaged
		maximumDamage = 0.3;
